...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference("Habit.count") do
      post habits_url, params: { habit: { description: @habit.description, name: @habit.name, user_id: @habit.user_id } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { description: @habit.description, name: @habit.name, user_id: @habit.user_id } }
